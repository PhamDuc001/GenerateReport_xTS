                    ...
                    <table class="summary">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                /
                                <xsl:value-of select="Result/@suite_plan"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                /
                                <xsl:value-of select="Result/@suite_build_number"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                (
                                <xsl:value-of select="Result/@os_name"/>
                                -<xsl:value-of select="Result/@os_version"/>)
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <xsl:value-of select="Result/Build/@build_version_release"/>
                                (<xsl:value-of select="Result/Build/@build_version_sdk"/>)
                            </td>
                        </tr>
                        <tr>
                ...
                <div>
                    <table class="testsummary">
                        ...
                        <xsl:for-each select="Result/Module">
                            <tr>
                                <td>
                                    <xsl:variable name="href"><xsl:value-of select="@abi"/>&#xA0;<xsl:value-of
                                            select="@name"/>
                                    </xsl:variable>
                                    <a href="#{$href}"><xsl:value-of select="@abi"/>&#xA0;<xsl:value-of select="@name"/>
                                    </a>
                                </td>
                                <td>
                    ...
                    <table class="testdetails">
                        <tr>
                            <td class="module" colspan="3">
                                ...
                                <a name="{$href}"><xsl:value-of select="@abi"/>&#xA0;<xsl:value-of select="@name"/>
                                </a>
                            </td>
                        </tr>
                        ...
                        <xsl:for-each select="TestCase">
                            ...
                            <xsl:for-each select="Test">
                                <xsl:if test="$resultFilter='' or @result=$resultFilter">
                                    <tr>
                                        <td class="testname"><xsl:value-of select="$TestCase/@name"/>#
